...
Le contenu peut-être programmé depuis un fichier au format Hex (Intel) au moyen de la commande d'écriture offert par uOS "`<E0+data0+data1+data2+...+data255`" (cf. [eeprom_4xds18b20.hex](Products/eeprom_4xds18b20.hex))
