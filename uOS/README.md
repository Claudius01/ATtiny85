...
- Utilisation d'adresses en SRAM pour le *mapping* en prolongement des appels hors de uOS comme l'initialisation logicielle, matérielle, gestion des *timers*, support d enouvelles commandes, etc. 
