...
#ident "@(#) micro-infos $Id: goGenerateProjectAllModes.sh,v 1.3 2026/01/06 17:00:19 administrateur Exp $"
...
do
	...
	do
		...
		${AVRA_BIN} -D ${_USE_MINIMALIST_UOS} -D ${mode_usi} -D ${_USE_MINIMALIST_ADDONS} \
...
do
	...
	echo "Sizes memory"
	echo "------------"
	egrep "G_SRAM_END_OF_USE|end_of_prg_uos" $d/*.map
